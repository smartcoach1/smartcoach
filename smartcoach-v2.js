  ...
  function injectStyles(primaryColor) {
    ...
    var css = [
      ...
      "@media(max-width:767px){",
        ...
        "#sc2-root .sc2-inner{padding:0 12px 12px 12px}",
        "#sc2-root .sc2-topbar{padding:7px 8px 0 8px}",
        "#sc2-root .sc2-headline{font-size:17px;margin:0 0 6px 0}",
        "#sc2-root .sc2-subheadline{font-size:13px;margin:0 0 10px 0}",
        "#sc2-root .sc2-coach-row{margin-bottom:7px}",
        "#sc2-root .sc2-options{gap:7px}",
        "#sc2-root .sc2-option{padding:9px 12px;font-size:13px;background:#f9f9f9;border:1.5px solid #eeeeee}",
